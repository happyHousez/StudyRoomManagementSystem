...
<div class="loginmanage">
    <div class="py-container">
        <h4 class="manage-title">云预约-自习室管理系统</h4>
        <div class="loginform">
            <ul class="sui-nav nav-tabs tab-wraped">
                <li class="active">
                    <h3 style="color: #053055">账户登录</h3>
                </li>
            </ul>
            <div class="tab-content tab-wraped">
                ...
                <div id="profile" class="tab-pane  active">
                    <form id="loginform" class="sui-form" action="${pageContext.request.contextPath}/user/login"
                        ...
                        <div class="logined" >
                            <a class="sui-btn btn-block btn-xlarge btn-danger" style="background-color: #053055;border:1px solid #053055"
