...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="${pageContext.request.contextPath}/admin/main.jsp" class="logo">
            <span class="logo-lg"><b>云预约-自习室管理系统</b></span>
        </a>
        <!-- 头部导航 -->
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="${pageContext.request.contextPath}/room/searchRooms" target="iframe">
                                <i class="fa fa-circle-o"></i>自习室预约
                            </a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/appoint/searchAppoint" target="iframe">
...
<%--                frameborder="0" src="${pageContext.request.contextPath}/book/selectNewbooks"></iframe>--%>
    <iframe width="100%" id="iframe" name="iframe" onload="SetIFrameHeight()"
            frameborder="0" src="${pageContext.request.contextPath}/room/selectHotRoom"></iframe>
    </div>
</div>
</body>
</html>