        ...
        <c:forEach items="${pageResult.rows}" var="user">
            <tr>
                ...
                <td class="text-center">
                    ...
                    <c:if test="${user.status == 1}">
                        <button type="button" class="btn bg-olive btn-xs" onclick="delectUser(${user.id})">删除</button>
                    </c:if>
